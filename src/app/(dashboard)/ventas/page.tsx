              ...
              return (
                ...
                >
                  ...
                  <div className="relative w-24 min-h-[80px] bg-muted flex-shrink-0">
                    <Image src={product.image || "/assets/trago.png"} alt={product.name} fill className="object-cover" sizes="96px" />
                  </div>
                  {/* Info right half */}
            ...
            {orderItems.length === 0 ? (
              ...
              orderItems.map((item) => (
                <div key={item.product.id} className="flex items-center gap-3 animate-fade-in">
                  <div className="relative w-8 h-8 rounded overflow-hidden flex-shrink-0"><Image src={item.product.image || "/assets/trago.png"} alt={item.product.name} fill className="object-cover" sizes="32px" /></div>
