...
export const mockSucursales: Sucursal[] = [
  { id: '1', nombre: 'Zona Rosa', ciudad: 'Bogota', direccion: 'Cra 14 #83-28, Zona Rosa', estado: 'ACTIVA', ventasHoy: '$3.24M', empleados: 12, ticketProm: '$40k', participacion: 43, administrador: 'Andrea Torres', desde: 'Desde Mar 2020', color: 'bg-orange-500' },
  { id: '2', nombre: 'Chapinero', ciudad: 'Bogota', direccion: 'Cl 63 #11-52, Chapinero', estado: 'ACTIVA', ventasHoy: '$2.15M', empleados: 10, ticketProm: '$34k', participacion: 31, administrador: 'Roberto Salinas', desde: 'Desde Sep 2021', color: 'bg-blue-500' },
  { id: '3', nombre: 'El Poblado', ciudad: 'Medellin', direccion: 'Cra 37 #10A-30, El Poblado', estado: 'ACTIVA', ventasHoy: '$1.98M', empleados: 9, ticketProm: '$31k', participacion: 26, administrador: 'Camila Reyes', desde: 'Desde Feb 2023', color: 'bg-green-500' },
  { id: '4', nombre: 'Laureles', ciudad: 'Medellin', direccion: 'Cl 33 #76A-15, Laureles', estado: 'EN CONSTRUCCION', administrador: 'Por definir', desde: 'Desde Sep 2026 (est.)', color: 'bg-purple-500' },
];

// ============ Usuarios Data ============
export const mockUsers: User[] = [
  { id: '1', name: 'Carlos Mendoza', email: 'superadmin@barbeer.com', role: 'superadmin', sede: 'Todas', initials: 'CM', estado: 'activo', ultimoAcceso: 'Hace 5 min' },
  { id: '2', name: 'Andrea Torres', email: 'admin@barbeer.com', role: 'administrador', sede: 'Zona Rosa', initials: 'AT', estado: 'activo', ultimoAcceso: 'Hace 2 horas' },
  { id: '3', name: 'Roberto Salinas', email: 'rsalinas@barbeer.com', role: 'administrador', sede: 'Chapinero', initials: 'RS', estado: 'activo', ultimoAcceso: 'Ayer' },
  { id: '4', name: 'Camila Reyes', email: 'creyes@barbeer.com', role: 'administrador', sede: 'El Poblado', initials: 'CR', estado: 'activo', ultimoAcceso: 'Hace 1 hora' },
  { id: '5', name: 'Miguel Rios', email: 'cajero@barbeer.com', role: 'empleado', sede: 'Zona Rosa', initials: 'MR', estado: 'activo', ultimoAcceso: 'Hace 10 min' },
  { id: '6', name: 'Diana Vargas', email: 'dvargas@barbeer.com', role: 'empleado', sede: 'Zona Rosa', initials: 'DV', estado: 'activo', ultimoAcceso: 'Hace 30 min' },
  { id: '7', name: 'Luis Castro', email: 'lcastro@barbeer.com', role: 'empleado', sede: 'Zona Rosa', initials: 'LC', estado: 'activo', ultimoAcceso: 'Hace 1 hora' },
  { id: '8', name: 'Sofia Gomez', email: 'sgomez@barbeer.com', role: 'empleado', sede: 'Chapinero', initials: 'SG', estado: 'activo', ultimoAcceso: 'Hace 3 horas' },
  { id: '9', name: 'Andres Perez', email: 'aperez@barbeer.com', role: 'empleado', sede: 'Chapinero', initials: 'AP', estado: 'activo', ultimoAcceso: 'Ayer' },
  { id: '10', name: 'Karen Lopez', email: 'klopez@barbeer.com', role: 'empleado', sede: 'El Poblado', initials: 'KL', estado: 'activo', ultimoAcceso: 'Hace 2 dias' },
  { id: '11', name: 'Pedro Martinez', email: 'pmartinez@barbeer.com', role: 'empleado', sede: 'El Poblado', initials: 'PM', estado: 'inactivo', ultimoAcceso: 'Hace 1 mes' },
];
